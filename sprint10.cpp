...
if(cin.fail())
{
    cin.clear();
    cin.ignore(1000,'\n');
    cout<<"Invalid Input !! Enter a number from 1 to 9."<<endl<<endl;
    continue;
}
			...
			case 3 :
{
    ...
    // your existing file-saving code continues here...
		        ofstream file("expenses.txt");
					...
					do
{
    ...
    if(cin.fail())
    {
        cin.clear();
        cin.ignore(1000,'\n');
        cout<<"Invalid Budget Entered ..!!"<<endl<<endl;
        continue;
    }
